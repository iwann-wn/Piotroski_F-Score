        ...
        if ($_FILES['file']['error'] === UPLOAD_ERR_OK) {
            ...
            if (in_array($fileInfo['extension'], ['xlsx', 'xls'])) {
                ...
                foreach ($data as $row) {
                    ...
                    // Dump skor untuk setiap elemen
                    echo "Kode Saham: $kode_saham<br>";
                    echo "Skor net income: $net_income_score<br>";
                    echo "Skor operating cashflow: $operating_cashflow_score<br>";
                    echo "Skor return on asset: $return_on_asset_score<br>";
                    echo "Skor quality of earning: $quality_of_earning_score<br>";
                    echo "Skor long term debt to asset: $long_term_debt_score<br>";
                    echo "Skor current ratio: $current_ratio_score<br>";
                    echo "Skor outstanding shares: $outstanding_shares_score<br>";
                    echo "Skor gross margin: $gross_margin_score<br>";
                    echo "Skor asset turnover: $asset_turnover_score<br>";
